...
class HFM(object):
    ...
    def train(self, total_time, learning_rate, alpha):
        ...
        saver = tf.train.import_meta_graph('my-model1.meta')
...
def start_train():
    ...
    # =============================================================================
    model.train(total_time=0.8, learning_rate=1e-3, alpha=0)
    # =============================================================================
    time_steps_test = 600
    ...
    for i in range(test_n):
        ...
        ax[0, 2].imshow(kon_loss.reshape(200, 200),  cmap=plt.get_cmap('OrRd'), vmin=0, vmax=1)  # row=0,)  # row=1, col=0
        ...
        ax[1, 2].imshow(koff_loss.reshape(200, 200), cmap=plt.get_cmap('OrRd'), vmin=0, vmax=1)  # row=0,)  # row=1, col=0
        ...
        ax[2, 2].imshow(Ci_loss.reshape(200, 200),  cmap=plt.get_cmap('OrRd'), vmin=0, vmax=1)  # row=0,)  # row=1, col=0
        ...
        ax[3, 2].imshow(Cb_loss.reshape(200, 200),  cmap=plt.get_cmap('OrRd'), vmin=0, vmax=1)  # row=0,)  # row=1, col=0
