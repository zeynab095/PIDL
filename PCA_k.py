...
class HFM(object):
    ...
    def __init__(self, t_data, x_data, y_data, Ci_data, Cb_data,
        ...
        # data
        [self.t_data, self.x_data, self.y_data, self.Ci_data, self.Cb_data, self.kon_data, self.koff_data] = [t_data, x_data, y_data, Ci_data, Cb_data, kon_data, koff_data]
        ...
        self.loss = mean_squared_error(self.Cb_data_pred, self.Cb_data_tf) + \
                    mean_squared_error(self.Ci_data_pred, self.Ci_data_tf) + \
...
def start_train():
    ...
    for i in range(20):
        ...
        fig.suptitle('Time: ' + str(j), fontsize=16)
